...
**Tech Stack:** Java 17、Spring Boot 3、Maven、MySQL、Redis、Flyway、MyBatis-Plus、Vue 3、Vite、Element Plus、Pinia、Vitest。
...
AiTourAssistant/
  ...
  backend/
    ...
    src/main/java/com/aitour/api/HealthController.java
    src/main/resources/application.yml
    src/main/resources/application-dev.yml
    src/main/resources/db/migration/V1__init_foundation.sql
    src/test/java/com/aitour/api/HealthControllerTest.java
...
- Create: `backend/src/test/java/com/aitour/api/HealthControllerTest.java`
- Create: `backend/src/main/java/com/aitour/AiTourAssistantApplication.java`
- Create: `backend/src/main/java/com/aitour/api/HealthController.java`
...
写入 `backend/src/main/java/com/aitour/api/HealthController.java`：
...
```bash
git add backend/pom.xml backend/src/main/java/com/aitour/AiTourAssistantApplication.java backend/src/main/java/com/aitour/api/HealthController.java backend/src/test/java/com/aitour/api/HealthControllerTest.java
